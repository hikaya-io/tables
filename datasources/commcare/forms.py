...
class CommCareAuthForm(CommCareProjectForm):
    username = forms.CharField(max_length=60, required=True)
    auth_token = forms.CharField(required=True, widget=forms.PasswordInput(), help_text=mark_safe("This gives hikaya access to your CommCare reports. Your api key can be found in your CommCare <a href='https://www.commcarehq.org/account/settings/' target='_blank'>settings</a>"))
